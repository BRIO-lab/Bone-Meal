...
class Configuration:
    def __init__(self):
        ...
        self.datamodule = {
            ...
            'CKPT_FILE': 'C:/Users/cwell/Documents/Bone_Meal/checkpoints/' + self.init['WANDB_RUN_GROUP'] + self.init['MODEL_NAME'] + '.ckpt', 
            'BATCH_SIZE': 4,
        ...
        self.net = {
            # 'hrt_small', 'hrnet'
            'BACKBONE': 'hrnet',    # the name of the backbone identified in backbone_selector. Currently we have support for hrt and hrnet
            # 'seg_hrt', 'seg_hrnet'
